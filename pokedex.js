...
//     .then(res=> res.json())
//     .then((data)=> {
//         let pic = document.querySelector("#type");
//         type.textContent = '${data.types[0].type.name} type pokemon';
//         let moves = document.querySelectorAll("li")[i];
//         FileList.textContent = data.moves[i*8].move.name;
//     }

//     let height = document.querySelector("#height");
//     height.textContent = 'Height: ${data.heig}';
